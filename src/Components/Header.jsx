...
import { useCategory } from "../Contexts/CategoryContext"; // GET DASHBOARD CATEGORIES
...
const Header = () => {
  ...
  const { categories } = useCategory(); // CATEGORY LIST FROM DASHBOARD
