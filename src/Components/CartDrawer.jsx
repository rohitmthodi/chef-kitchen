  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto space-y-6 text-white mt-4 mb-4">
        {cart.length === 0 ? (
          <p className="text-gray-400 font-medium flex justify-center items-center ">Cart is empty</p>
        ) : (
          cart.map((item) => {
                  ...
                  <div className="flex gap-3 min-w-0">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <div className="flex gap-2 font-semibold">
                        <p className="flex items-center text-orange-500 border border-white/25 rounded-lg px-2 text-xs">
                          {sizeLabel[item.size]}
                        </p>
